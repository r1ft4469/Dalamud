    ...
    internal class InterfaceManager : IDisposable
    {
        ...
        private IntPtr PresentDetour(IntPtr swapChain, uint syncInterval, uint presentFlags)
        {
            if (this.scene == null)
            {
                ...
                ImGui.GetStyle().Colors[(int)ImGuiCol.WindowBg] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.FrameBg] = new Vector4(0.137f, 0.149f, 0.165f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.FrameBgHovered] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.FrameBgActive] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.TitleBgActive] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.CheckMark] = new Vector4(0.439f, 0.510f, 0.816f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.SliderGrab] = new Vector4(0.259f, 0.267f, 0.302f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.SliderGrabActive] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.Button] = new Vector4(0.259f, 0.267f, 0.302f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.ButtonHovered] = new Vector4(0.259f, 0.267f, 0.302f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.ButtonActive] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.Header] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.HeaderHovered] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.HeaderActive] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.ResizeGrip] = new Vector4(0.79f, 0.79f, 0.79f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.ResizeGripHovered] = new Vector4(0.137f, 0.153f, 0.173f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.ResizeGripActive] = new Vector4(0.439f, 0.510f, 0.816f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.Tab] = new Vector4(0.259f, 0.267f, 0.302f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.TabHovered] = new Vector4(0.259f, 0.267f, 0.302f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.TabActive] = new Vector4(0.439f, 0.510f, 0.816f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.MenuBarBg] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.NavHighlight] = new Vector4(0.439f, 0.510f, 0.816f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.NavWindowingDimBg] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.NavWindowingHighlight] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
                ImGui.GetStyle().Colors[(int)ImGuiCol.TitleBg] = new Vector4(0.173f, 0.184f, 0.204f, 1.00f);
